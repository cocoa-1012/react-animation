...
export const Sample = ({ onClick }) => {
  return (
    <motion.div
      className="absolute bg-red-500/[.8] rounded-[10px] w-[26px] h-[26px] top-[10px] right-[10px] flex justify-center items-center cursor-pointer"
      onClick={onClick}
      variants={button}
      initial="rest"
      whileHover="hover"
